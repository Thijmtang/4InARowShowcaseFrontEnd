    ...
    <FormCard>
      ...
      <Form onSubmit={handleSubmit(onSubmit, onError)}>
          ...
          <Form.Control
            ...
            {...register("password", {
              ...
              pattern: {
                ...
                message:
                  "Het wachtwoord moet minimaal één kleine letter, één hoofdletter, één cijfer en één speciaal teken bevatten en minimaal zes tekens lang zijn",
              },
            })}
          />

          {errors?.password && (
            <Form.Text className="text-danger" data-cy="error-password">
        ...
        <Form.Group className="footer">
          ...
          <Link to="/login" data-cy="link-login">
